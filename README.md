...
This repository serves as a host for files relating to The UK Philosophy Webring. Submit a Pull Request to be added (or removed!) from the Webring.
...
Though my HTML and CSS have been improving over this year, my JS leaves a lot to be desired. Fortunately for me, and for other philosophers similarly inclined, Chris Coyier at CSS-Tricks developed a tutorial and helpful code template for a modern Webring! Thanks Chris. 

I would have forked Chris' repository for direct credit, but I'm new to Github and was worried about accidentally pushing changes, so thought it safer to create a separate repo, just in case!
